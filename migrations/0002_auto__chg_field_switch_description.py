...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Switch.description'
        db.alter_column(u'switches_switch', 'description', self.gf('django.db.models.fields.TextField')())
    ...
    models = {
        ...
        u'switches.switch': {
            ...
            'description': ('django.db.models.fields.TextField', [], {'default': "''", 'max_length': '64', 'blank': 'True'}),
